@php
     ...
     * @var object $selectedDateAttendances
     */
@endphp
@extends('layouts.app')
            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <div class="">
                                ...
                                <div class="fv-row col-4">
                                    ...
                                    <select id="cohort_id" data-control="select2" class="form-select form-select-solid"
                                        ...
                                        @foreach($cohortWithItsCourses as $cohort)
                                            <option value="{{ $cohort['cohort']->id }}">{{ $cohort['cohort']->name }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Input-->
                                </div>
                        ...
                        <div class="separator bg-secondary border-2 d-none"></div>
                        ...
                        <div class="card-header px-0 border-bottom-dashed border-2">
                            <form method="get" id="attendance_view" action="{{ route('attendance.index') }}">
                                <div class="btn-group w-300px mt-4 card-title" data-kt-buttons="true"
                            ...
                            <div class="d-flex justify-content-end card-toolbar" data-kt-student-table-toolbar="base">
                                ...
                                <a href="{{ route('attendance.create') }}" type="button" class="btn btn-primary">
