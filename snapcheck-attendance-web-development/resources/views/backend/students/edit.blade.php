        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    <form method="POST" id="form" class="form" action="{{ route('student.update', $student) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                @if(!is_null($student->profile_path))
                                    <style>.image-input-placeholder { background-image: url({{asset($student->profile_path)}}); } [data-bs-theme="dark"] .image-input-placeholder { background-image: url({{asset('metronic/demo6/dist/assets/media/svg/files/blank-image-dark.svg')}}); }</style>
                                @else
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input id="student_name" type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0 w-100 w-md-25" placeholder="SnapCheck" value="{{ $student->name }}" />
                                <div class="fv-plugins-message-container invalid-feedback">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row mw-500px mb-5" data-kt-buttons="true" data-kt-buttons-target=".form-check-image, .form-check-input">>
                                    <!--begin::Col-->
                                    <div class="col-4">
                                        <label class="form-check-image @if($student->gender == \App\Enum\GenderEnum::MALE) active @endif ">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid me-10">
                                                <input @if($student->gender == \App\Enum\GenderEnum::MALE) checked @endif class="form-check-input" type="radio" value="{{ \App\Enum\GenderEnum::MALE }}" name="gender" id="text_wow"/>
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-4">
                                        <label class="form-check-image @if($student->gender == \App\Enum\GenderEnum::FEMALE) active @endif">
                                            <div class="form-check-wrapper w-100px border border-2">
                                                <img src="{{ asset('metronic/demo6/dist/assets/media/svg/avatars/003-girl-1.svg') }}"/>
                                            </div>

                                            <div class="form-check form-check-custom form-check-solid me-10">
                                                <input @if($student->gender == \App\Enum\GenderEnum::FEMALE) checked @endif class="form-check-input" type="radio" value="{{ \App\Enum\GenderEnum::FEMALE }}" name="gender"/>
                                                <div class="form-check-label">
                                                    Female
                                                </div>
                                            </div>
                            ...
                            <div class="fv-row mb-7  w-100 w-md-25">
                                <!--begin::Label-->
                                <label for="cohort_id" class="required fw-semibold fs-6 mb-2">Cohort</label>
